...
var hljsGrammar = (() => {
  ...
  function t(...n) {
    ...
    return "(" + (a.capture ? "" : "?:") + n.map((n) => e(n)).join("|") + ")";
  }
  ...
  return (e) => {
    const d = { match: /\s+/, relevance: 0 },
      ...
      v = { match: [/\./, t(...s, ...c)], className: { 2: "keyword" } },
      C = { match: a(/\./, t(...r)), relevance: 0 },
      ...
      D = [
        ...
        { className: "built_in", match: a(/\b/, t(...p), /(?=\()/) },
      ],
      _ = { match: /->/, relevance: 0 },
      M = [
        _,
      ...
      W = [
        {
          ...
          starts: {
            contains: [
              { begin: /\(/, end: /\)/, keywords: E, contains: [...M, L, K] },
            ],
          },
        },
        {
    ...
    const X = {
      ...
      Y = {
        match: [/(func|macro)/, /\s+/, t(G.match, w, b)],
